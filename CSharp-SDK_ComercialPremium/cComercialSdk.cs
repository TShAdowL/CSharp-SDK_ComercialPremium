...
namespace CSharp_SDK_ComercialPremium {
    public static class cComercialSdk {        
        ...
        public static extern int fAltaMovimientoCaracteristicas(int aIdMovimiento, ref int aIdMovtoCaracteristicas, ref tCaracteristicas aCaracteristicas);
        ...
        public static extern int fAltaCuentaBancariaEmpresa(ref int aIdCtaBancaria, string aCuentaBancaria, string aNombreCuenta, string aNombreMoneda, string aClaveBanco, string aCLABE, string aRFCBanco, string aNombreBancoExtranjero);
        ...
        public static extern int fModificaCuentaBancariaEmpresa(string aCuentaBancaria, string aNombreCuenta, string aNombreMoneda, string aClaveBanco, string aRFCBanco, string aCLABE, string aNombreBancoExtranjero);

        [DllImport("MGWServicios.dll", EntryPoint = "fModificaCuentaBancariaCliente")]
        public static extern int fModificaCuentaBancariaCliente(string aCuentaBancaria, string aNombreCuenta, string aNombreMoneda, string aClaveBanco, string aRFCBanco, string aCLABE, string aNombreBancoExtranjero, string aCodigoCliente);
